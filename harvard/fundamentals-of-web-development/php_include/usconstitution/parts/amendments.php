...
<html lang="en">
	...
	<body id="part8" class="this_should_be_the_body">
		<div class="container">
	...
	include ('includes/header.php');
			...
			<div class="row">
				...
				<div class="nine columns">
					<main>
						<p>
							Proposed by Congress, and ratified by the legislatures of the several states, purusant to the Fifth Article of the original Constitution.
						</p>
						<h2>Article I</h2>
						<p>
						...
						<p>
							Section 2. Representatives shall be apportioned among the several States according to their respective numbers, counting the whole number of persons in each State, excluding Indians not taxed. But when the right to vote at any election for the choice of electors for President and Vice President of the United States, Representatives in Congress, the Executive and Judicial officers of a State, or the members of the Legislature thereof, is denied to any of the male inhabitants of such State, being twenty-one years of age,<i>(See Note 15)</i> and citizens of the United States, or in any way abridged, except for participation in rebellion, or other crime, the basis of representation therein shall be reduced in the proportion which the number of such male citizens shall bear to the whole number of male citizens twenty-one years of age in such State.
						</p>
						<p>
						...
						<h2>Article XVIII].<i>(See Note 16)</i></h2>
						<p>
			...
			include ('includes/stat_counter.inc.html');
			?>
		</div>
	</body>
