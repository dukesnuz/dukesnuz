...
<html lang="en">
  <head>
    ...
    <title>Testing PCRE All Matches</title>
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
	  {
		...
		echo 'TRUE!</p>';
		//print matches
		echo '<p class="error">' . print_r($matches, 1) . '</p>';
		}else{
		echo 'FALSE!</p>';
		}
}//end if submission
...
<p>I like the color scheme I used for these chapter forms.</p>

<section id="formback">


<form id="form" action="14_02_matches.php" method="post">
	<fieldset>
				...
				<p>Subject:<input class="field" name="subject" type="text" 
...
<footer>
  <p><a href="http://dukesnuz.com/d/phppercolate6/ch14/14_03_replace.php">Excercise 14.3</a></p>
</footer>
