<?php
    ...
    define('MODWRITE', '/d/phppercolate_7/ecom-2/ch_10');
	
	//define constants for authorize.net
	//https://sandbox.authorize.net/
	//Your Payment Gateway ID is: 473372
	//define('API_LOGIN_ID', '3vhaWDX48pCT');
	//define('TRANSACTION_KEY', '473372');
	define('API_LOGIN_ID', '3vhaWDX48pCT');
	define('TRANSACTION_KEY', '2fc5N9Jt8RX4S45U');
