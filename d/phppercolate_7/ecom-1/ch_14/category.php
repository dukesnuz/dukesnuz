	 ...
	 if(isset($_SESSION['user_id']) && !isset($_SESSION['user_not_expired']))
	    {
	    	...
	    	Unfortunately your account has expired.  Please <a href="##">renew your account</a>
		 ...
		 */
		     //chapter 12 page 406 multiple categories
		     //also chp 12 page 409 added AND status="live"
		   $q= 'SELECT id, title, description FROM pages, pages_catagories
		     	WHERE pages.id=pages_catagories.page_id
		     	AND
		     	pages_catagories.catagory_id ='.$cat_id.' 
		     	AND
		     	status="live"
		     	ORDER BY date_created DESC';
