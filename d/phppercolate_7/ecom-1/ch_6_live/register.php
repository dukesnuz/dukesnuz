...
if($_SERVER['REQUEST_METHOD'] === 'POST')
   {
	 ...
	 // $q = "INSERT INTO users (username, email, pass, first_name, last_name, date_expires)
		...
		if(mysqli_affected_rows($dbc) === 1)
		{
			...
			//used for first section in chp 6 using thanks.php
			...
			echo '<div class="alert alert-success"><h3>Thanks!</h3><p>Thank you for registering!
			    ...
			    site access via PayPal.  The cost is $1.00(US) per year. <strong>Note: When you complete
...
//below used for cp 6 first section using thanks.php
//below for demo
/*
 *  echo '
...
<input type="hidden" name="custom" value="'.$e.'">
...
<input type="hidden" name="hosted_button_id" value="9AQSHTM5T8H4S">
<input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.sandbox.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
';

 //below used for  chp 6 2nd section  ipn.php
 //below live
/*echo '
<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
<input type="hidden" name="cmd" value="_s-xclick">
...
<input type="hidden" name="hosted_button_id" value="ZKYY6SM6AN83N">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
';
...
?>
<h1>Register</h1>
<p>Access to the site's content is available to registered users at a cost of $1.00 (US) per year.
