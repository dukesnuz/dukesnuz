...
if (filter_var($_GET['id'], FILTER_VALIDATE_INT, array('min_range' => 1))) {
	...
	{
	 echo '<p>00pp! This page has been removed from your favorites!<img src="images/close_32.png" border="0" width="32" height="32" align="middle" /></p>';
	   
	}else{
		
		trigger_error('OOppss ! A system error occurred. We apologize for any inconvenience.');
	}
  ...
  // No valid ID.
	...
	echo '<p class="error">OOppss! This page has been accessed in error.</p>';
