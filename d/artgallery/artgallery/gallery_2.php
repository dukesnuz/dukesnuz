...
<meta name="description" content="The Art Gallery Two @dukesnuz. Created using jQuery anything slider, mySqli and Filemaker." />
...
<title>Art Gallery Two || Dukesnuz.com</title>
...
$q= "SELECT picture_name, img_url, comment FROM Artgallery  
  where active ='Yes'
  AND
  trim(gallery_select) ='GalleryTwo'
...
<div class="wrapper">
  ...
  <div class="content">
    <div class="main">
      ...
      <h2>The Art Gallery Two of Duke</h2>
	  <h3>
	  	<a href="http://dukesnuz.com/d/home.php"  title="Dukes home page">Home</a>
	  	||
	  	<a href="http://dukesnuz.com/d/artgallery/gallery_1.php"  title="Visit Art Gallery Two">Gallery One</a>	
				&nbsp&nbsp  You are in Gallery Two</h3>
    ...
    while($rows = mysqli_fetch_array($r, MYSQLI_ASSOC))
	{
	   ?>
			 ...
			 $picture = trim('<img src="'.trim($rows['img_url']).'" width="450" height="525"alt="The Art gallery of Duke">');	
			 ?> 
 ...
 <div id="footer">
    ...
    <p>I have since changed to a mySqli database to store each picture's information. I using Filemaker to insert, edit and delete each pictures information.</p>
