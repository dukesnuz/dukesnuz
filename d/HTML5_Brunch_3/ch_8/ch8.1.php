...
/*
if (isset($_COOKIE['features'])) {
    $feature = json_decode($_COOKIE['features']);
}
$width = $feature->width ? $feature->width : $device->getCapability('resolution_width');
if ($width <= 480) {
    $smallScreen = true;
} else {
    $smallScreen = false;
...
<html lang="en">
<head>
    <title>Yet Another Sports Magazine</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width" />
    <link rel="stylesheet" href="css/style-8.1.css" />
	<!--[if (lt IE 9) & (!IEMobile)]>
