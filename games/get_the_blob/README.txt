Future ideas
				...
				Future plans for this section. Add function to store favorite places in local storage.
				Print favorite places here along with option button to display location on map.
				Or if a game is created store high scores in local storage and display here.
				show who is online and playing
